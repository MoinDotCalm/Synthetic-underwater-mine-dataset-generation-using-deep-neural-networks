...
try:
    ...
    # Total iterations
    final_iter = 15000    #35000 best 2)25000
    
    # Assign the batch value
    batch_size = 21         #42 best 2)21

    #20% of the data will automatically be used for validation
    validation_size = 0.2
    img_size = 32         #128/32
    num_channels = 3
    train_path=r'C:\Users\moini\OneDrive\Desktop\major project\part B\dataset\train'
    ...
    def train(num_iteration):
        ...
        for i in range(total_iterations,
            ...
            if i % int(data.train.num_examples/batch_size) == 0: 
                ...
                saver.save(session, 'C:\\Users\\moini\\OneDrive\\Desktop\\major project\\part B\\models\\trained_model') 
...
plt.xlabel("Epochs")
plt.ylabel("Accuracy")
plt.title("Trend of the Accuracy with every Epoch:")
plt.legend(['train'])
plt.show()
